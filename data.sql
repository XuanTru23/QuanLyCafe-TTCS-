...
VALUES  ( N'Admin' , -- UserName - nvarchar(100)
          N'Quản trị viên' , -- DisplayName - nvarchar(100)
...
VALUES  ( N'NhanVien' , -- UserName - nvarchar(100)
          ...
          'nhanvien' , -- PassWord - nvarchar(1000)
          0  -- Type - int
        )
...
insert dbo.FoodCategory ( name ) Values ( N'Đô ăn' )
insert dbo.FoodCategory ( name ) Values ( N'Trà sữa' )
insert dbo.FoodCategory ( name ) Values ( N'Sinh tố' )
go
-- Thêm món ăn
insert dbo.Food ( name, idCategory, price ) Values ( N'Sinh tố đào', 5, 25000)
insert dbo.Food ( name, idCategory, price ) Values ( N'Bò khô', 3, 15000)
insert dbo.Food ( name, idCategory, price ) Values ( N'Trà sữa trân châu', 4, 25000)
insert dbo.Food ( name, idCategory, price ) Values ( N'Trà đào', 2, 25000)
insert dbo.Food ( name, idCategory, price ) Values ( N'Cà phê Capuchino', 1, 90000)
go
